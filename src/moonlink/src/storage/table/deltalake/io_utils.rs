...
/// Get a unique filepath for delta table data filepath.
#[allow(unused)]
fn generate_unique_data_filepath(table_location: &str, local_filepath: &String) -> String {
...
pub(crate) async fn upload_data_file_to_delta(
    ...
    let remote_filepath = generate_unique_data_filepath(table_location, local_filepath);
